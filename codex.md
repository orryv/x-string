...
2. Think about more tests/examples (important, relevant and/or useful ones, test exceptions and edge cases too,) that could be added to the docs. And add them. Some tests may be about (not limited to):
  ...
  - nested paths (min 1 test)
  - wildcard paths (min 1 test)
  - recursive operations (min 1 test)
  - empty arrays (min 1 test)
  - single-element arrays (min 1 test)
  - non-array values at the path (throws NotAnArrayException) (min 1 test)
  - malformed path selectors (throws InvalidPathException) (min 1 test)
  ...
  - array in path (should throw InvalidPathException) (min 1 test)
