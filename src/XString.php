...
/**
 * Magic proxy methods exposed via __call()/__callStatic() for IDE support.
 * @method int length()
 * @method static int length()
 * @method int byteLength()
 * @method static int byteLength()
 * @method int graphemeLength()
 * @method static int graphemeLength()
 * @method self withMode(string $mode = self::DEFAULT_MODE, string $encoding = self::DEFAULT_ENCODING)
 * @method static self withMode(string $mode = self::DEFAULT_MODE, string $encoding = self::DEFAULT_ENCODING)
 * @method self asBytes(string $encoding = self::DEFAULT_ENCODING)
 * @method static self asBytes(string $encoding = self::DEFAULT_ENCODING)
 * @method self asCodepoints(string $encoding = self::DEFAULT_ENCODING)
 * @method static self asCodepoints(string $encoding = self::DEFAULT_ENCODING)
 * @method self asGraphemes(string $encoding = self::DEFAULT_ENCODING)
 * @method static self asGraphemes(string $encoding = self::DEFAULT_ENCODING)
 * @method string charAt(int $index)
 * @method static string charAt(int $index)
 * @method self append(HtmlTag|Newline|Regex|Stringable|string|array|null $data)
 * @method static self append(HtmlTag|Newline|Regex|Stringable|string|array|null $data)
 * @method self prepend(HtmlTag|Newline|Regex|Stringable|string|array|null $data)
 * @method static self prepend(HtmlTag|Newline|Regex|Stringable|string|array|null $data)
 * @method self substr(int $start, ?int $length = null)
 * @method static self substr(int $start, ?int $length = null)
 * @method self limit(int $length, HtmlTag|Newline|Stringable|string $append_string = '...')
 * @method static self limit(int $length, HtmlTag|Newline|Stringable|string $append_string = '...')
 * @method self repeat(int $times)
 * @method static self repeat(int $times)
 * @method self reverse()
 * @method static self reverse()
 * @method self shuffle()
 * @method static self shuffle()
 * @method self slug(Newline|HtmlTag|string $separator = '-')
 * @method static self slug(Newline|HtmlTag|string $separator = '-')
 * @method self fileNameSlug(Newline|HtmlTag|string $separator = '-')
 * @method static self fileNameSlug(Newline|HtmlTag|string $separator = '-')
 * @method self toWindowsFileName()
 * @method static self toWindowsFileName()
 * @method self toWindowsFolderName()
 * @method static self toWindowsFolderName()
 * @method self toWindowsPath()
 * @method static self toWindowsPath()
 * @method self encodeWindowsFileName(bool $double_encode = false)
 * @method static self encodeWindowsFileName(bool $double_encode = false)
 * @method self decodeWindowsFileName()
 * @method static self decodeWindowsFileName()
 * @method self encodeWindowsFolderName(bool $double_encode = false)
 * @method static self encodeWindowsFolderName(bool $double_encode = false)
 * @method self decodeWindowsFolderName()
 * @method static self decodeWindowsFolderName()
 * @method self encodeWindowsPath(bool $double_encode = false)
 * @method static self encodeWindowsPath(bool $double_encode = false)
 * @method self decodeWindowsPath()
 * @method static self decodeWindowsPath()
 * @method self toUnixFileName()
 * @method static self toUnixFileName()
 * @method self toUnixFolderName()
 * @method static self toUnixFolderName()
 * @method self toUnixPath()
 * @method static self toUnixPath()
 * @method self encodeUnixFileName(bool $double_encode = false)
 * @method static self encodeUnixFileName(bool $double_encode = false)
 * @method self decodeUnixFileName()
 * @method static self decodeUnixFileName()
 * @method self encodeUnixFolderName(bool $double_encode = false)
 * @method static self encodeUnixFolderName(bool $double_encode = false)
 * @method self decodeUnixFolderName()
 * @method static self decodeUnixFolderName()
 * @method self encodeUnixPath(bool $double_encode = false)
 * @method static self encodeUnixPath(bool $double_encode = false)
 * @method self decodeUnixPath()
 * @method static self decodeUnixPath()
 * @method self toMacOSFileName()
 * @method static self toMacOSFileName()
 * @method self toMacOSFolderName()
 * @method static self toMacOSFolderName()
 * @method self toMacOSPath()
 * @method static self toMacOSPath()
 * @method self encodeMacOSFileName(bool $double_encode = false)
 * @method static self encodeMacOSFileName(bool $double_encode = false)
 * @method self decodeMacOSFileName()
 * @method static self decodeMacOSFileName()
 * @method self encodeMacOSFolderName(bool $double_encode = false)
 * @method static self encodeMacOSFolderName(bool $double_encode = false)
 * @method self decodeMacOSFolderName()
 * @method static self decodeMacOSFolderName()
 * @method self encodeMacOSPath(bool $double_encode = false)
 * @method static self encodeMacOSPath(bool $double_encode = false)
 * @method self decodeMacOSPath()
 * @method static self decodeMacOSPath()
 * @method self toSafeFileName()
 * @method static self toSafeFileName()
 * @method self toSafeFolderName()
 * @method static self toSafeFolderName()
 * @method self toSafePath()
 * @method static self toSafePath()
 * @method self encodeSafeFileName(bool $double_encode = false)
 * @method static self encodeSafeFileName(bool $double_encode = false)
 * @method self decodeSafeFileName()
 * @method static self decodeSafeFileName()
 * @method self encodeSafeFolderName(bool $double_encode = false)
 * @method static self encodeSafeFolderName(bool $double_encode = false)
 * @method self decodeSafeFolderName()
 * @method static self decodeSafeFolderName()
 * @method self encodeSafePath(bool $double_encode = false)
 * @method static self encodeSafePath(bool $double_encode = false)
 * @method self decodeSafePath()
 * @method static self decodeSafePath()
 * @method self insertAtInterval(Newline|HtmlTag|Regex|string $insert, int $interval)
 * @method static self insertAtInterval(Newline|HtmlTag|Regex|string $insert, int $interval)
 * @method self wrap(Newline|HtmlTag|Regex|string $before, Newline|HtmlTag|Regex|string|null $after = null)
 * @method static self wrap(Newline|HtmlTag|Regex|string $before, Newline|HtmlTag|Regex|string|null $after = null)
 * @method self indent(int $spaces = 2, int $tabs = 0, int $lines = 0)
 * @method static self indent(int $spaces = 2, int $tabs = 0, int $lines = 0)
 * @method self outdent(int $spaces = 2, int $tabs = 0, int $lines = 0)
 * @method static self outdent(int $spaces = 2, int $tabs = 0, int $lines = 0)
 * @method self normalize(int $form = Normalizer::FORM_C)
 * @method static self normalize(int $form = Normalizer::FORM_C)
 * @method self pad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ', bool $left = true, bool $right = true)
 * @method static self pad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ', bool $left = true, bool $right = true)
 * @method self lpad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method static self lpad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method self rpad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method static self rpad(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method self center(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method static self center(int $length, Newline|HtmlTag|Regex|string $pad_string = ' ')
 * @method self mask(Newline|HtmlTag|Regex|string $mask, Newline|HtmlTag|Regex|string $mask_char = '#', bool $reversed = false)
 * @method static self mask(Newline|HtmlTag|Regex|string $mask, Newline|HtmlTag|Regex|string $mask_char = '#', bool $reversed = false)
 * @method self collapseWhitespace(bool $space = true, bool $tab = true, bool $newline = false)
 * @method static self collapseWhitespace(bool $space = true, bool $tab = true, bool $newline = false)
 * @method self collapseWhitespaceToSpace()
 * @method static self collapseWhitespaceToSpace()
 * @method self collapseWhitespaceToTab()
 * @method static self collapseWhitespaceToTab()
 * @method self collapseWhitespaceToNewline()
 * @method static self collapseWhitespaceToNewline()
 * @method self between(HtmlTag|Newline|Regex|Stringable|string|array $start, HtmlTag|Newline|Regex|Stringable|string|array $end, bool $last_occurence = false, int $skip_start = 0, int $skip_end = 0, string $start_behavior = 'sequential', string $end_behavior = 'sequential')
 * @method static self between(HtmlTag|Newline|Regex|Stringable|string|array $start, HtmlTag|Newline|Regex|Stringable|string|array $end, bool $last_occurence = false, int $skip_start = 0, int $skip_end = 0, string $start_behavior = 'sequential', string $end_behavior = 'sequential')
 * @method array betweenAll(HtmlTag|Newline|Regex|Stringable|string|array $start, HtmlTag|Newline|Regex|Stringable|string|array $end, bool $reversed = false, string $start_behavior = 'sequential', string $end_behavior = 'sequential')
 * @method static array betweenAll(HtmlTag|Newline|Regex|Stringable|string|array $start, HtmlTag|Newline|Regex|Stringable|string|array $end, bool $reversed = false, string $start_behavior = 'sequential', string $end_behavior = 'sequential')
 * @method self before(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $last_occurence = false, int $skip = 0, string $start_behavior = 'sequential')
 * @method static self before(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $last_occurence = false, int $skip = 0, string $start_behavior = 'sequential')
 * @method self after(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $last_occurence = false, int $skip = 0, string $start_behavior = 'sequential')
 * @method static self after(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $last_occurence = false, int $skip = 0, string $start_behavior = 'sequential')
 * @method array split(HtmlTag|Newline|Regex|Stringable|string|array $delimiter, ?int $limit = null)
 * @method static array split(HtmlTag|Newline|Regex|Stringable|string|array $delimiter, ?int $limit = null)
 * @method array explode(HtmlTag|Newline|Regex|Stringable|string|array $delimiter, ?int $limit = null)
 * @method static array explode(HtmlTag|Newline|Regex|Stringable|string|array $delimiter, ?int $limit = null)
 * @method array lines(bool $trim = false, ?int $limit = null)
 * @method static array lines(bool $trim = false, ?int $limit = null)
 * @method int lineCount()
 * @method static int lineCount()
 * @method array words(bool $trim = false, ?int $limit = null)
 * @method static array words(bool $trim = false, ?int $limit = null)
 * @method int wordCount()
 * @method static int wordCount()
 * @method int sentenceCount()
 * @method static int sentenceCount()
 * @method self toSnake(Newline|HtmlTag|Regex|string|array $input_delimiter = ' ')
 * @method static self toSnake(Newline|HtmlTag|Regex|string|array $input_delimiter = ' ')
 * @method self toKebab()
 * @method static self toKebab()
 * @method self toCamel(bool $capitalize_first = false)
 * @method static self toCamel(bool $capitalize_first = false)
 * @method self toTitle()
 * @method static self toTitle()
 * @method self toPascal()
 * @method static self toPascal()
 * @method ?self match(Regex|array $pattern, int $offset = 0)
 * @method static ?self match(Regex|array $pattern, int $offset = 0)
 * @method array matchAll(Regex|array $pattern, false|int $limit = false, array|int|null $flags = PREG_PATTERN_ORDER)
 * @method static array matchAll(Regex|array $pattern, false|int $limit = false, array|int|null $flags = PREG_PATTERN_ORDER)
 * @method self trim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method static self trim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method self ltrim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method static self ltrim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method self rtrim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method static self rtrim(bool $newline = true, bool $space = true, bool $tab = true)
 * @method self replace(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace, ?int $limit = null, bool $reversed = false)
 * @method static self replace(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace, ?int $limit = null, bool $reversed = false)
 * @method self replaceFirst(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace)
 * @method static self replaceFirst(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace)
 * @method self replaceLast(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace)
 * @method static self replaceLast(HtmlTag|Newline|Regex|Stringable|string|array $search, HtmlTag|Newline|Regex|Stringable|string $replace)
 * @method self strip(HtmlTag|Newline|Regex|Stringable|string|array $search, ?int $limit = null, bool $reversed = false)
 * @method static self strip(HtmlTag|Newline|Regex|Stringable|string|array $search, ?int $limit = null, bool $reversed = false)
 * @method self stripEmojis()
 * @method static self stripEmojis()
 * @method self stripTags(HtmlTag|Newline|Regex|Stringable|string|array $allowed_tags = '')
 * @method static self stripTags(HtmlTag|Newline|Regex|Stringable|string|array $allowed_tags = '')
 * @method self stripAccents()
 * @method static self stripAccents()
 * @method self ensurePrefix(Newline|HtmlTag|string $prefix)
 * @method static self ensurePrefix(Newline|HtmlTag|string $prefix)
 * @method self ensureSuffix(Newline|HtmlTag|string $suffix)
 * @method static self ensureSuffix(Newline|HtmlTag|string $suffix)
 * @method self removePrefix(HtmlTag|Newline|Regex|Stringable|string|array $prefix)
 * @method static self removePrefix(HtmlTag|Newline|Regex|Stringable|string|array $prefix)
 * @method self removeSuffix(HtmlTag|Newline|Regex|Stringable|string|array $suffix)
 * @method static self removeSuffix(HtmlTag|Newline|Regex|Stringable|string|array $suffix)
 * @method self togglePrefix(Newline|HtmlTag|string $prefix)
 * @method static self togglePrefix(Newline|HtmlTag|string $prefix)
 * @method self toggleSuffix(Newline|HtmlTag|string $suffix)
 * @method static self toggleSuffix(Newline|HtmlTag|string $suffix)
 * @method bool hasPrefix(HtmlTag|Newline|Regex|Stringable|string|array $prefix)
 * @method static bool hasPrefix(HtmlTag|Newline|Regex|Stringable|string|array $prefix)
 * @method bool hasSuffix(HtmlTag|Newline|Regex|Stringable|string|array $suffix)
 * @method static bool hasSuffix(HtmlTag|Newline|Regex|Stringable|string|array $suffix)
 * @method bool contains(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method static bool contains(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method false|int|array indexOf(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $reversed = false, int|bool $limit = 1, string $behavior = 'or')
 * @method static false|int|array indexOf(HtmlTag|Newline|Regex|Stringable|string|array $search, bool $reversed = false, int|bool $limit = 1, string $behavior = 'or')
 * @method bool isEmpty(bool $newline = true, bool $space = true, bool $tab = true)
 * @method static bool isEmpty(bool $newline = true, bool $space = true, bool $tab = true)
 * @method bool startsWith(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method static bool startsWith(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method bool endsWith(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method static bool endsWith(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method bool equals(HtmlTag|Newline|Regex|Stringable|string|array $string, bool $case_sensitive = true)
 * @method static bool equals(HtmlTag|Newline|Regex|Stringable|string|array $string, bool $case_sensitive = true)
 * @method int countOccurrences(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method static int countOccurrences(HtmlTag|Newline|Regex|Stringable|string|array $search)
 * @method float similarityScore(HtmlTag|Newline|Regex|Stringable|string|array $comparison, string $algorithm = 'github-style', array $options = [])
 * @method static float similarityScore(HtmlTag|Newline|Regex|Stringable|string|array $comparison, string $algorithm = 'github-style', array $options = [])
 * @method self transliterate(string $to = 'ASCII//TRANSLIT')
 * @method static self transliterate(string $to = 'ASCII//TRANSLIT')
 * @method self toEncoding(string $to_encoding, ?string $from_encoding = null)
 * @method static self toEncoding(string $to_encoding, ?string $from_encoding = null)
 * @method string|false detectEncoding(array $encodings = ['UTF-8', 'ISO-8859-1', 'ASCII'])
 * @method static string|false detectEncoding(array $encodings = ['UTF-8', 'ISO-8859-1', 'ASCII'])
 * @method bool isValidEncoding(?string $encoding = null)
 * @method static bool isValidEncoding(?string $encoding = null)
 * @method bool isAscii()
 * @method static bool isAscii()
 * @method bool isUtf8()
 * @method static bool isUtf8()
 * @method self toUtf8(?string $from_encoding = null)
 * @method static self toUtf8(?string $from_encoding = null)
 * @method self toAscii(?string $from_encoding = null)
 * @method static self toAscii(?string $from_encoding = null)
 * @method self encodeHtmlEntities(int $flags = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, ?string $encoding = null, bool $double_encode = false)
 * @method static self encodeHtmlEntities(int $flags = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, ?string $encoding = null, bool $double_encode = false)
 * @method self decodeHtmlEntities(int $flags = ENT_QUOTES | ENT_HTML401, ?string $encoding = null)
 * @method static self decodeHtmlEntities(int $flags = ENT_QUOTES | ENT_HTML401, ?string $encoding = null)
 * @method int toInt()
 * @method static int toInt()
 * @method float toFloat()
 * @method static float toFloat()
 * @method bool toBool()
 * @method static bool toBool()
 * @method self base64Encode()
 * @method static self base64Encode()
 * @method self base64Decode()
 * @method static self base64Decode()
 * @method self md5(bool $raw_output = false)
 * @method static self md5(bool $raw_output = false)
 * @method self crc32(bool $raw_output = false)
 * @method static self crc32(bool $raw_output = false)
 * @method self sha1(bool $raw_output = false)
 * @method static self sha1(bool $raw_output = false)
 * @method self sha256(bool $raw_output = false)
 * @method static self sha256(bool $raw_output = false)
 * @method self crypt(string $salt)
 * @method static self crypt(string $salt)
 * @method self passwordHash(int|string $algo = PASSWORD_BCRYPT, array $options = [])
 * @method static self passwordHash(int|string $algo = PASSWORD_BCRYPT, array $options = [])
 * @method bool passwordVerify(string $hash)
 * @method static bool passwordVerify(string $hash)
 * @method self encrypt(string $password, string $cipher = 'sodium_xchacha20')
 * @method static self encrypt(string $password, string $cipher = 'sodium_xchacha20')
 * @method self decrypt(string $password, string $cipher = 'sodium_xchacha20')
 * @method static self decrypt(string $password, string $cipher = 'sodium_xchacha20')
 * @method self htmlEscape(int $flags = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML5, string $encoding = 'UTF-8')
 * @method static self htmlEscape(int $flags = ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML5, string $encoding = 'UTF-8')
 * @method self htmlUnescape()
 * @method static self htmlUnescape()
 * @method self urlEncode(bool $raw = false)
 * @method static self urlEncode(bool $raw = false)
 * @method self urlDecode(bool $raw = false)
 * @method static self urlDecode(bool $raw = false)
 * @method self nl2br(bool $is_xhtml = true)
 * @method static self nl2br(bool $is_xhtml = true)
 * @method self br2nl()
 * @method static self br2nl()
 * @method self toUpper()
 * @method static self toUpper()
 * @method self toUpperCase()
 * @method static self toUpperCase()
 * @method self toLower()
 * @method static self toLower()
 * @method self toLowerCase()
 * @method static self toLowerCase()
 * @method self ucfirst()
