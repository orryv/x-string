...
searching, skipping occurrences, and resolving compound delimiters through arrays.
...
- **Array delimiters.** Arrays are evaluated sequentially, letting you match multi-token boundaries.
