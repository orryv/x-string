...
| [`replaceFirst`](docs/x-string/methods/replaceFirst.md) | 1.0 | `public function replaceFirst(Newline\|Regex\|Multibyte\|Byte\|Grapheme\|string\|array<Newline\|Regex\|Multibyte\|Byte\|Grapheme\|string> $search, Newline\|Multibyte\|Byte\|Grapheme\|string $replace): self`<br>Replace the first occurrence of a string with another string. |
...
| [`fileNameSlug`](docs/x-string/methods/fileNameSlug.md) | 1.0 | `public function fileNameSlug(Newline\|Multibyte\|Byte\|Grapheme\|string $separator = '-'): self`<br>Generate a filesystem-safe filename by replacing invalid characters while preserving extensions. |
